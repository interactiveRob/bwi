...
<div class="container-fluid js-parking custom_cont custom_parkingcls test">
   <div class="row">
      <header class="parking_header">
         ...
         <h2 class="parking_title">
            <?php echo $title; ?>
            <span class="parking_title_label js-parking_time"
                  data-realtime
                  data-realtime-reveal
                  data-key="timestamp"> <time><?php echo $parking_op['updated']; ?></time></span>
         </h2>
   ...
   <div class="row parking_body_row">
      <div class="parking_body">
         ...
         <div data-realtime-container
              class="parking_item js-parking-item  js-parking_class <?php echo $hourly_garage['class']; ?>"
              data-name="Hourly Garage">
            <header>
               <div class="parking_item_status_wrapper">
                  <span class="parking_item_status js-parking_status"
                        data-realtime
                        data-key="Hourly__status"><?php print_r($hourly_garage['status']); ?></span>
               </div>
               <h3 class="parking_item_quantity"><span class="js-parking_percent"
                        data-realtime
                        data-key="Hourly__percentage"><?php print_r($hourly_garage['percentage']); ?></span>%<span
                        class="parking_item_available"> available</span></h3>
               <div class="parking_item_details">
                  <h4 class="parking_item_type">Hourly Garage</h4>
               </div>
               <h5 class="parking_item_spaces"><span data-realtime
                        data-key="Hourly__available"><?php print_r($hourly_garage['available']); ?></span> of
                  <?= $hourly_garage['total'] ?> spaces available</h5>
            ...
            <div class="parking_item_body">
               ...
               <a class="parking_item_link"
                  href="/to-from-bwi/parking/hourly-garage/">
                  <span>
								Learn about our Hourly Garage
							</span>
                  <svg aria-hidden="true"
                       class="symbol symbol_arrow_right symbol_gray">
		...
		?>
         <div data-realtime-container
              class="parking_item js-parking-item  js-parking_class <?php echo $daily_garage['class']; ?>"
              data-name="Daily Garage">
            <header>
               <div class="parking_item_status_wrapper">
                  <span class="parking_item_status js-parking_status"
                        data-realtime
                        data-key="Daily__status"><?php print_r($daily_garage['status']); ?></span>
               </div>
               <h3 class="parking_item_quantity"><span class="js-parking_percent"
                        data-realtime
                        data-key="Daily__percentage"><?php print_r($daily_garage['percentage']); ?></span>%<span
                        class="parking_item_available"> available</span></h3>
               <div class="parking_item_details">
                  <h4 class="parking_item_type">Daily Garage</h4>
               </div>
               <h5 class="parking_item_spaces"><span data-realtime
                        data-key="Daily__available"><?php print_r($daily_garage['available']); ?></span> of
                  <?= $daily_garage['total'] ?> spaces available</h5>
            ...
            <div class="parking_item_body">
               ...
               <a class="parking_item_link"
                  href="/to-from-bwi/parking/daily-garage/">
                  <span>
		...
		?>
         <div data-realtime-container
              class="parking_item js-parking-item  js-parking_class <?php echo $express_parking['class']; ?>"
              data-name="Express Parking">
            <header>
               <div class="parking_item_status_wrapper">
                  <span class="parking_item_status js-parking_status"
                        data-realtime
                        data-key="Express__status"><?php print_r($express_parking['status']); ?></span>
               </div>
               <h3 class="parking_item_quantity"><span class="js-parking_percent"
                        data-realtime
                        data-key="Express__percentage"><?php print_r($express_parking['percentage']); ?></span>%<span
                        class="parking_item_available"> available</span></h3>
               <div class="parking_item_details">
                  <h4 class="parking_item_type">Express Parking</h4>
               </div>
               <h5 class="parking_item_spaces"><span data-realtime
                        data-key="Express__available"><?php print_r($express_parking['available']); ?></span> of
                  <?= $express_parking['total'] ?> spaces available</h5>
            ...
            <div class="parking_item_body">
               ...
               <a class="parking_item_link"
                  href="/to-from-bwi/parking/express-parking/">
                  <span>
		...
		?>
         <div data-realtime-container
              class="parking_item js-parking-item  js-parking_class <?php echo $long_term_parking_a['class']; ?>"
              data-name="Long Term Lot A">
            <header>
               <div class="parking_item_status_wrapper">
                  <span class="parking_item_status js-parking_status"
                        data-realtime
                        data-key="Long-Term A__status"><?php print_r($long_term_parking_a['status']); ?></span>
               </div>
               <h3 class="parking_item_quantity"><span class="js-parking_percent"
                        data-realtime
                        data-key="Long-Term A__percentage"><?php print_r($long_term_parking_a['percentage']); ?></span>%<span
                        class="parking_item_available"> available</span></h3>
               <div class="parking_item_details">
                  <h4 class="parking_item_type">Long Term Parking A</h4>
               </div>
               <h5 class="parking_item_spaces"><span data-realtime
                        data-key="Long-Term A__available"><?php print_r($long_term_parking_a['available']); ?></span> of
                  <?= $long_term_parking_a['total'] ?> spaces available</h5>
            ...
            <div class="parking_item_body">
               ...
               <a class="parking_item_link"
                  href="/to-from-bwi/parking/long-term-parking/">
                  <span>
		...
		?>
         <div data-realtime-container
              class="parking_item js-parking-item  js-parking_class <?php echo $long_term_parking_b['class']; ?>"
              data-name="Long Term Lot B">
            <header>
               <div class="parking_item_status_wrapper">
                  <span class="parking_item_status js-parking_status"
                        data-realtime
                        data-key="Long-Term B__status"><?php print_r($long_term_parking_b['status']); ?></span>
               </div>
               <h3 class="parking_item_quantity"><span class="js-parking_percent"
                        data-realtime
                        data-key="Long-Term B__percentage"><?php print_r($long_term_parking_b['percentage']); ?></span>%<span
                        class="parking_item_available"> available</span></h3>
               <div class="parking_item_details">
                  <h4 class="parking_item_type">Long Term Parking B</h4>
               </div>
               <h5 class="parking_item_spaces"><span data-realtime
                        data-key="Long-Term B__available"> <?php print_r($long_term_parking_b['available']); ?></span>
                  of
                  <?= $long_term_parking_b['total'] ?> spaces available</h5>

        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12 ">
                ...
                <section class="schedule" id="schedule">
                    <div class="row">
                        <div class="schedule_body">
                            <div class="schedule_switches">
                                <button class="js-swap schedule_switch fs-swap-element fs-swap-enabled <?php if((isset($pagename) && $pagename == "arrival") || (isset($_GET['hud_arrival_depature']) && $_GET['hud_arrival_depature'] == 'arrival')){ echo "fs-swap-active"; }elseif($pagename == "departure" || $_GET['hud_arrival_depature'] == 'departure'){ echo ""; }else{ echo "fs-swap-active"; }?>" data-swap-group="schedule_switch" data-swap-target=".schedule_section_1" data-swap-options="{&quot;collapse&quot;: false}" data-swap-active="true">Arrivals</button>
                                <button class="js-swap schedule_switch fs-swap-element fs-swap-enabled <?php if((isset($pagename) && $pagename == "departure") || (isset($_GET['hud_arrival_depature']) && $_GET['hud_arrival_depature'] == 'departure')){ echo "fs-swap-active"; }?>" data-swap-group="schedule_switch" data-swap-target=".schedule_section_2" data-swap-options="{&quot;collapse&quot;: false}">Departures</button>
                            </div>
                            ...
                            <div class="fs-dropdown_wrapper schedule_dropdown_wrapper">
                                ...
                                <div class="fs-scrollbar-content"><button type="button" class="fs-dropdown-item fs-dropdown-item_selected" data-value="1" role="option" aria-selected="true">Arrivals</button><button type="button" class="fs-dropdown-item" data-value="2" role="option">Departures</button></div></div></div>
                       ...
                       <select class="schedule_airline_switcher_select"  onchange="filterByAirline(this.value,1)" ><option value="Select an Airline">Select an Airline</option><option value="Air Canada">Air Canada</option><option value="Alaska">Alaska</option><option value="American">American</option><option value="Avelo">Avelo</option><option value="British Airways">British Airways</option><option value="Condor">Condor</option><option value="Contour Airlines">Contour Airlines</option><option value="Delta">Delta</option><option value="Frontier">Frontier</option><option value="Icelandair">Icelandair</option><option value="JetBlue">JetBlue</option><option value="PLAY">PLAY</option><option value="Southwest">Southwest</option><option value="Spirit Airlines">Spirit Airlines</option><option value="Sun Country">Sun Country</option><option value="United">United</option></select>
                    </div>

                    <div class="schedule_section schedule_section_1 fs-swap-target fs-swap-enabled <?php if((isset($pagename) && $pagename == "arrival") || (isset($_GET['hud_arrival_depature']) && $_GET['hud_arrival_depature'] == 'arrival')){ echo "fs-swap-active"; }elseif($pagename == "departure" || $_GET['hud_arrival_depature'] == 'departure'){ echo ""; }else{ echo "fs-swap-active"; }?>">
                    ...
                    <div class="schedule_section departure-sec-tab schedule_section_2 fs-swap-target fs-swap-enabled <?php if((isset($pagename) && $pagename == "departure") || (isset($_GET['hud_arrival_depature']) && $_GET['hud_arrival_depature'] == 'departure')){ echo "fs-swap-active"; }?>">
                        <div class="schedule_list">
                            <div class="responsive_table">
...
?>
 ...
 #schedule_table_mobile_1_filter, #schedule_table_mobile_2_filter {display: none;}
</style>
                    ...
                    if(htmlString.Arrivals || htmlString.Departures){
                       // console.log(htmlString.Arrivals)
                        ...
                        if ( ! $.fn.DataTable.isDataTable( '#schedule_table_1' ) ) {
                            ...
                            $('#schedule_table_1, #schedule_table_2').DataTable({ paging: false  });
                            $('#schedule_table_mobile_1, #schedule_table_mobile_2').DataTable({ paging: false  });

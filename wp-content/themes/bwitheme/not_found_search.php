...
<div class="container-fluid custom_cont search_results">
    <div class="row">
        <div class="found_content_cell">
            
            <div class="page_header">
                <div class="typography">
                    <h1 class="page_title_alternate">Page Not Found</h1>
                    <p class="spotlight_caption">Uh oh!  We need to get you to the right place, because where you landed isn't right.  Try getting to your page from our homepage.</p>
<p style="font-weight: 600 !important;">Helpful Links:</p>
<ul>
<li><a href="/">BWI Marshall Homepage</a></li>
<li><a href="/flying-with-us/flights/">Flight Arrivals / Departures</a></li>
<li><a href="/to-from-bwi/parking/">Parking Information</a></li>
<li><a href="/at-bwi/">Airport Information</a></li>
<li><a href="/flying-with-us/security/">Security Information</a></li>
</ul>
                </div>
<!--/*content-->
            </div>
            <div class="search_body">
                ...
                <?php while( have_posts() ): ?>
                    ...
                    <!--    <div class="search_title"><a href="<?php the_permalink(); ?>" class="title"><h2><?php the_title(); ?></h2></a></div>-->

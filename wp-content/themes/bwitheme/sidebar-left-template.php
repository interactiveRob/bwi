...
*/
    ...
    if (have_rows('modules')) {
      while (have_rows('modules')) {
        ...
        if (get_row_layout() == 'page_values_group') {
          $page_values = get_sub_field('page_values');
          $sub_caption = isset($page_values['page_sub-title']) ? $page_values['page_sub-title'] : null;
          $check = isset($page_values['check-if_it_is_parent_page']) ? $page_values['check-if_it_is_parent_page'] : null;
        }
    ...
    if ($skip_content_btn == '1') { ?>
      <div class="skip_content_btn">
        <a href="#main_content_scroll" class="plan_link"><span>Skip to Main Content</span><svg class="symbol symbol_arrow_right symbol_red">
    ...
    if (!empty($header_image['url'])) { ?>
            ...
            <div class="container">
              <div class="row">
                <div class="botton-section-row-body">
                  ...
                  <?php if (!empty($sub_caption)){ ?>
                    <p class="botton-section-row_caption"><?php echo esc_html($sub_caption); ?></p>
                  <?php } ?>
                </div>
              </div>
            </div>
      ...
      <!-- <div class="container-fluid custom_cont top_header_image" style='background-image: url("<?php //echo $header_image['url']; 
                                                                                                    ?>"); opacity: 1;'>
    <div class="spotlight_row">
    <div class="row">
        <div class="spotlight_body">
                <h1 class="spotlight_title"><?php //echo the_title(); 
                                            ?></h1>
                <?php //if (isset($sub_caption)) { 
                ?>
                <p class="spotlight_caption"><?php //print_r($sub_caption); 
                                              ?></p>
                <?php //} 
                ?>
...
?>
    ...
    <div class="container custom_contcls <?php echo (empty($header_image['url']) && !$check) ? 'third_level_page' : ''; ?>">
      ...
      <div class="row">
        ...
        <div class="col-sm-8">
          ...
          <div class="typography">
            <?php if (empty($header_image['url']) && !$check) { ?>
